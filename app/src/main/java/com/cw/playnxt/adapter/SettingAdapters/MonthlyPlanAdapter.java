...
public class MonthlyPlanAdapter extends RecyclerView.Adapter<MonthlyPlanAdapter.RecyclerViewHolder> {
    Context context;
    List<AnnualPlanDataModel> list;
    ItemClick itemClick;

    public MonthlyPlanAdapter(Context context, List<AnnualPlanDataModel> list,ItemClick itemClick) {
