...
public class GetCategoryNameWishListAdapter extends RecyclerView.Adapter<GetCategoryNameWishListAdapter.RecyclerViewHolder> {
    Context context;
    List<Wishlist> list;
    ...
    public GetCategoryNameWishListAdapter(Context context, List<Wishlist> list, ItemClickId itemClick) {
    ...
    @NonNull
    @Override
    public GetCategoryNameWishListAdapter.RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull RecyclerViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.binding.llMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // Call listener
                itemClick.onItemClick(position, list.get(position).getId(),"CategoryNameWishlist");
