...
public final class ItemListRecentGamesBinding implements ViewBinding {
  @NonNull
  ...
  private ItemListRecentGamesBinding(@NonNull CardView rootView, @NonNull LinearLayout btnView,
  ...
  @NonNull
  public static ItemListRecentGamesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemListRecentGamesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_list_recent_games, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemListRecentGamesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemListRecentGamesBinding((CardView) rootView, btnView, gameImg, gameName,
          layoutMain, txtBtn);
    }
