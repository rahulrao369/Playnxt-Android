...
public final class ActivityAboutUsBinding implements ViewBinding {
  ...
  private ActivityAboutUsBinding(@NonNull RelativeLayout rootView,
      @NonNull HeaderLayoutBinding bindingHeader, @NonNull TextView tvAboutUs) {
  ...
  public static ActivityAboutUsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAboutUsBinding((RelativeLayout) rootView, binding_bindingHeader,
          tvAboutUs);
    }
