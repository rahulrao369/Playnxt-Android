...
public final class ItemListSearchGamesBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ItemListSearchGamesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemListSearchGamesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_list_search_games, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemListSearchGamesBinding bind(@NonNull View rootView) {
