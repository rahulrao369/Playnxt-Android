...
public final class DialogThankyouBinding implements ViewBinding {
  ...
  private DialogThankyouBinding(@NonNull CardView rootView, @NonNull ImageView image,
  ...
  public static DialogThankyouBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_thankyou, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogThankyouBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogThankyouBinding((CardView) rootView, image, text1, txtOk);
    }
