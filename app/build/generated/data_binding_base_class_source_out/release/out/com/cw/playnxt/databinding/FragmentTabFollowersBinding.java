...
public final class FragmentTabFollowersBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentTabFollowersBinding(@NonNull FrameLayout rootView, @NonNull LinearLayout llMain,
      @NonNull LinearLayout llNoData, @NonNull ProgressBar progressBar1,
      @NonNull RelativeLayout rlProgressBar, @NonNull RecyclerView rvFollowersList) {
  ...
  @NonNull
  public static FragmentTabFollowersBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentTabFollowersBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_tab_followers, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentTabFollowersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTabFollowersBinding((FrameLayout) rootView, llMain, llNoData, progressBar1,
          rlProgressBar, rvFollowersList);
    }
