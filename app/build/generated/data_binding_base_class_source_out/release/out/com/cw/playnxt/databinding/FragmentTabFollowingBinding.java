...
public final class FragmentTabFollowingBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentTabFollowingBinding(@NonNull FrameLayout rootView, @NonNull LinearLayout llMain,
      @NonNull LinearLayout llNoData, @NonNull ProgressBar progressBar1,
      @NonNull RelativeLayout rlProgressBar, @NonNull RecyclerView rvFollowingList) {
  ...
  @NonNull
  public static FragmentTabFollowingBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentTabFollowingBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_tab_following, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentTabFollowingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTabFollowingBinding((FrameLayout) rootView, llMain, llNoData, progressBar1,
          rlProgressBar, rvFollowingList);
    }
