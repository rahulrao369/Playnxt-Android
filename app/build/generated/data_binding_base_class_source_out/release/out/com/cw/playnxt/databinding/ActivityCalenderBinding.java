...
public final class ActivityCalenderBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout btnAddEvent;
  ...
  private ActivityCalenderBinding(@NonNull RelativeLayout rootView,
      @NonNull HeaderLayoutBinding bindingHeader, @NonNull LinearLayout btnAddEvent,
  ...
  public static ActivityCalenderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btnAddEvent;
      LinearLayout btnAddEvent = ViewBindings.findChildViewById(rootView, id);
      if (btnAddEvent == null) {
        break missingId;
      }
      ...
      return new ActivityCalenderBinding((RelativeLayout) rootView, binding_bindingHeader,
          btnAddEvent, calendarView, recyclerView);
    }
